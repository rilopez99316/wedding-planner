  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      {hotels.length > 0 && (
        <div className="grid grid-cols-3 gap-3">
          {/* Hotels */}
          <div className="relative bg-white rounded-2xl border border-gray-100 shadow-apple-sm px-4 py-3.5">
            <div className="absolute top-3 right-3 w-8 h-8 rounded-lg bg-accent-light flex items-center justify-center">
                ...
                <>
                    ...
                    <div className="flex flex-col items-end justify-between gap-3 shrink-0 min-w-[120px]">
                              ...
                              {Array.from({ length: total }).map((_, i) => (
                                <motion.div
                                  ...
                                  className={cn(
                                    ...
                                    i < booked ? "bg-accent" : "bg-gray-200"
                                  )}
                                />
                              ))}
                            </div>
                      ...
                      {h.bookingUrl && (
                        <a
                          ...
                          className="inline-flex items-center gap-1.5 text-xs font-semibold text-white bg-accent rounded-lg px-3 py-1.5 hover:brightness-105 transition-all shadow-apple-xs"
                        >
                          Book Now
                          <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                  ...
                  <div className="flex items-center justify-between gap-3 px-5 py-2.5 bg-gray-50 border-t border-gray-100">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      ...
                      {/* Delete */}
                      <button
                        onClick={() => setConfirmDeleteHotelId(confirmDeleteHotelId === h.id ? null : h.id)}
                    ...
                    {confirmDeleteHotelId === h.id && (
                      ...
                      >
                        <div className="flex items-center justify-between gap-3 px-5 py-3 bg-red-50 border-t border-red-100">
                          <p className="text-xs text-red-600 font-medium">Remove &ldquo;{h.name}&rdquo;?</p>
